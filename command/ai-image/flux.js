...
module.exports = {
  ...
  async execute(ctx) {
    ...
    try {
      ...
      const url = `https://gen.pollinations.ai/image/${encodedPrompt}?seed=${seed}&width=1024&height=1024&nologo=true&model=flux`;
      ...
      const imagePath = path.join(tempDir, `flux-${Date.now()}.png`);
