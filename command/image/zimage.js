...
module.exports = {
  ...
  async execute(ctx) {
    ...
    try {
      ...
      const url = `https://gen.pollinations.ai/image/${encodedPrompt}?seed=${seed}&width=1024&height=1024&nologo=true&model=zimage`;
      ...
      const imagePath = path.join(tempDir, `zimage-${Date.now()}.png`);
      ...
      console.error("zimage ERROR:", err.message);
